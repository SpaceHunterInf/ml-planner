...
#SBATCH --mail-user=gs06monitor@gmail.com
...
#! Insert additional module load commands after this line if neede
eval "$(conda shell.bash hook)"
conda activate planner
export PYTHONPATH="${PYTHONPATH}:text_autoencoder"
#! Full path to application executable:
application="python text_autoencoder/autoencoder/train.py"

#! Run options for the application:
options="--log_interval 200 --val_interval 200 --batch_size 128 --valid_size 1024 \
--epoch 5 \
--num_feature 16 --sentence_len 64 \
